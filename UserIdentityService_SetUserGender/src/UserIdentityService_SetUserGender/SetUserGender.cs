...
namespace UserIdentityService_SetUserGender
{
    public class LambdaHandler
    {
        ...
        public async Task<APIGatewayProxyResponse> handleRequest(APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            return await LambdaHelper.ExecuteAsync(request, APIHelper.REQUEST_METHOD_PUT, async (IDataStores dataStores, JObject requestBody) => {
                ...
                return await SetUserGender(dataStores, request.Headers, requestBody);
            });
        }
         ...
         * Set user gender.
         */
        internal async Task<APIGatewayProxyResponse> SetUserGender(IDataStores dataStores,
                                                                   ...
                                                                   JObject requestBody)
        {
            ...
            try {
                // Log call
                LoggingHelper.LogMessage($"UserIdentityService::SetUserGender()");
                ...
                // Check inputs
                SetUserGenderRequest setUserGenderRequest = UserIdentityService_SetUserGender_LogicLayer.CheckValidSetUserGenderRequest(requestBody);
                ...
                // Perform logic
                await UserIdentityService_SetUserGender_LogicLayer.SetUserGender(dbClient, loggedInUserId, setUserGenderRequest);
...
}   // UserIdentityService_SetUserGender
