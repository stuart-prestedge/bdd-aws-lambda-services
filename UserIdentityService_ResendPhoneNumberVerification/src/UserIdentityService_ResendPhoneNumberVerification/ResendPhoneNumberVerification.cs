...
namespace UserIdentityService_RsndPhoneNumberVerification
{
    public class LambdaHandler
    {
        ...
        public async Task<APIGatewayProxyResponse> handleRequest(APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            return await LambdaHelper.ExecuteAsync(request, APIHelper.REQUEST_METHOD_PUT, async (IDataStores dataStores, JObject requestBody) => {
                ...
                return await ResendPhoneNumberVerification(dataStores, request.Headers, requestBody);
            });
        }
         ...
         * Set user address.
         */
        private async Task<APIGatewayProxyResponse> ResendPhoneNumberVerification(IDataStores dataStores,
                                                                    ...
                                                                    JObject requestBody)
        {
            ...
            try {
                // Log call
                LoggingHelper.LogMessage($"UserIdentityService::ResendPhoneNumberVerification()");
                ...
                // Perform logic
                await UserIdentityService_ResendPhoneNumberVerification_LogicLayer.ResendPhoneNumberVerification(dbClient, loggedInUserId);
...
}   // UserIdentityService_ResendPhoneNumberVerification
